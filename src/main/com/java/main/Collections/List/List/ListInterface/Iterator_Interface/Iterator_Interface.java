...
*   Các phương thức của Iterator:
        - Iterator src.main.com.java.JavaCore.Interface cung cấp 4 phương thức:
...
*
*
*   * Ưu điểm của Iterator src.main.com.java.JavaCore.Interface
        + Nó không phải là một src.main.com.java.JavaCore.Interface kế thừa và có thể duyệt qua các phần tử của các tập hợp như ArrayList, HashMap, TreeSet, HashSet, và các tập hợp khác.
        + Nó có thể được sử dụng cho bất kỳ tập hợp nào.
        + Các thao tác đọc và xóa được hỗ trợ trong src.main.com.java.JavaCore.Interface này.
...
package src.main.com.java.main.Collections.List.List.ListInterface.Iterator_Interface;
...
public class Iterator_Interface {
    public static void main(String[] args) {
        ...
        // Iterator src.main.com.java.JavaCore.Interface trong Java
