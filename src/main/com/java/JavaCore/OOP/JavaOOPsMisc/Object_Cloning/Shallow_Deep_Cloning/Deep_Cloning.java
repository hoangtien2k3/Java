...
package src.main.com.java.JavaCore.OOP.JavaOOPsMisc.Object_Cloning.Shallow_Deep_Cloning;
...
public class Deep_Cloning {
    ...
    // deep cloning có lợi ích như thế nào so với shallow cloning.
    // khi nào thì cần dùng deep cloning trong java, và dùng deep cloning có mục đích như thế nào trong code
}