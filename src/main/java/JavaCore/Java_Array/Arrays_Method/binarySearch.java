/*
    => Phương thức binarySearch() được sử dụng để tìm vị trí của phần tử trong mảng bằng phương thức
    tìm kiếm nhị phân (binary search). Các phần tử trong mảng phải được sắp xếp trước khi gọi phương thức này.
    Nếu chưa sắp xếp, kết quả sẽ không chính xác.

* */

package src.main.java.JavaCore.Java_Array.Arrays_Method;
