...
/*
* syntax:
*       public src.main.java.JavaCore.Java_String.String split(src.main.java.JavaCore.Java_String.String regex)
        public src.main.java.JavaCore.Java_String.String split(src.main.java.JavaCore.Java_String.String regex, int limit)
*
