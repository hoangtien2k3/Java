...
*           int indexOf(int ch) //Trả về vị trị của giá trị Char đã cho.
            ...
            int indexOf(src.main.java.JavaCore.Java_String.String substring) //Trả về vị trị của chuỗi con.
            int indexOf(src.main.java.JavaCore.Java_String.String substring, int fromIndex) //Trả về vị trị của chuỗi con đã cho tính từ vị trí fromIndex.
*
* */
