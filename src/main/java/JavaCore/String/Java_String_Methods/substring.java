...
/*
*   syntax:
*       public src.main.java.JavaCore.Java_String.String substring(int startIndex)
        public src.main.java.JavaCore.Java_String.String substring(int startIndex, int endIndex)
*
