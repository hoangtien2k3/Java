...
package src.main.java.JavaCore.Java_Input_Output.OutputStream.FilterOutputStream.PrintStream;
...
public class PrintStreamExample {
    public static void main(String args[]) throws Exception {
        FileOutputStream fout = new FileOutputStream("D:\\Code Java\\Java\\src.main.java.JavaCore\\Java_Input_Output\\OutputStream\\FilterOutputStream\\PrintStream\\testPrintStream.txt ");
