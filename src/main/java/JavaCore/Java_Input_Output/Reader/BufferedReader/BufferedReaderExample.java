...
package src.main.java.JavaCore.Java_Input_Output.Reader.BufferedReader;
...
public class BufferedReaderExample {
    public static void main(String args[]) throws Exception {
        FileReader fr = new FileReader("D:\\Code Java\\Java\\src.main.java.JavaCore\\Java_Input_Output\\Reader\\BufferedReader\\TTT.txt");
