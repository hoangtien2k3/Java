...
package src.main.java.JavaCore.Java_Input_Output.Writer.FilerWriter;
...
public class FileWriterExample {
    public static void main(String args[]) {
        try {
            FileWriter fw = new FileWriter("D:\\Code Java\\Java\\src.main.java.JavaCore\\Java_Input_Output\\Writer\\FilerWriter\\FileText.txt");
