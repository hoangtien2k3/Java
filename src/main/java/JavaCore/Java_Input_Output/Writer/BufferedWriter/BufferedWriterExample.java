...
package src.main.java.JavaCore.Java_Input_Output.Writer.BufferedWriter;
...
public class BufferedWriterExample {
    public static void main(String[] args) throws Exception {
        FileWriter writer = new FileWriter("D:\\Code Java\\Java\\src.main.java.JavaCore\\Java_Input_Output\\Writer\\BufferedWriter\\tttest.txt");
