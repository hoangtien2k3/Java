...
package src.main.java.JavaCore.Java_Input_Output.InputStream.FilterInputStream.DataInputStream;
...
public class DataInputStreamExample {
    public static void main(String[] args) throws IOException {
        ...
        try {
            input = new FileInputStream("D:\\Code Java\\Java\\src.main.java.JavaCore\\Java_Input_Output\\InputStream\\FilterInputStream\\DataInputStream\\TESTOUT.txt");
