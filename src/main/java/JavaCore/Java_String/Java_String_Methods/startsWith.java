...
/*
*   syntax:
*       public boolean startsWith(src.main.java.JavaCore.Java_String.String prefix)
        public boolean startsWith(src.main.java.JavaCore.Java_String.String prefix, int offset)
*
