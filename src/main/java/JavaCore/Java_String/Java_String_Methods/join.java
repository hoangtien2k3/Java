...
/*
*  syntax:
*           public static src.main.java.JavaCore.Java_String.String join(CharSequence delimiter, CharSequence... elements)
            public static src.main.java.JavaCore.Java_String.String join(CharSequence delimiter, Iterable<? extends CharSequence> elements)
*
