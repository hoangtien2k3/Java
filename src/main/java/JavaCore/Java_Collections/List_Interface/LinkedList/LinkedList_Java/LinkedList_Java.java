...
*      List, Queue src.main.java.JavaCore.Interface trong Collections Framework nên nó sẽ có một vài đặc điểm và
...
package src.main.java.JavaCore.Java_Collections.List_Interface.LinkedList.LinkedList_Java;
