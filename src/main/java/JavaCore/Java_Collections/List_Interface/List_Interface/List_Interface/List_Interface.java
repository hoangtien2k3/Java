...
*
*   * List_Interface:
*       + List là một kiểu Collection và là src.main.java.JavaCore.Interface dành cho kiểu danh sách.
...
*
*
*   syntax List src.main.java.JavaCore.Interface:
*
...
*       Nguyên nhân là do các lớp: ArrayList, Vector hay LinkedList đều implement từ src.main.java.JavaCore.Interface List
*           Ex:
...
package src.main.java.JavaCore.Java_Collections.List_Interface.List_Interface.List_Interface;
