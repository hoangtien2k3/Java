/*
*   => Lớp HashMap trong java là một lớp kế thừa lớp AbstractMap và triển khai của Map src.main.java.JavaCore.Interface
...
package src.main.java.JavaCore.Java_Collections.Map_Interface.HashMap;
