...
*
*   * List_Interface:
*       + List là một kiểu Collection và là src.main.com.java.JavaCore.Interface dành cho kiểu danh sách.
...
*
*
*   syntax List src.main.com.java.JavaCore.Interface:
*
...
*       Nguyên nhân là do các lớp: ArrayList, Vector hay LinkedList đều implement từ src.main.com.java.JavaCore.Interface List
*           Ex:
...
package src.test.com.java.main.Collections.List.List.ListInterface;
