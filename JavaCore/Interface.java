...
public class Interface {
    public static void main(String[] args) {
        ...
        System.out.println("JavaCore.Circle area: " + circle.getArea());
        System.out.println("JavaCore.Circle perimeter: " + circle.getPerimeter());
        System.out.println("JavaCore.Rectangle area: " + rectangle.getArea());
        System.out.println("JavaCore.Rectangle perimeter: " + rectangle.getPerimeter());
    }
}