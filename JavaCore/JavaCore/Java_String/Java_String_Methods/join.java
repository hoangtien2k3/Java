...
/*
*  syntax:
*           public static JavaCore.Java_String.String join(CharSequence delimiter, CharSequence... elements)
            public static JavaCore.Java_String.String join(CharSequence delimiter, Iterable<? extends CharSequence> elements)
*
