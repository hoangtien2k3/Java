...
/*
* syntax:
*       public JavaCore.Java_String.String split(JavaCore.Java_String.String regex)
        public JavaCore.Java_String.String split(JavaCore.Java_String.String regex, int limit)
*
