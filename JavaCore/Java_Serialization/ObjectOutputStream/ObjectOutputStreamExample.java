...
package JavaCore.Java_Serialization.ObjectOutputStream;
...
public class ObjectOutputStreamExample extends Exception{
    public static void main(String[] args) throws IOException {
        ...
        try {
            oos = new ObjectOutputStream(new FileOutputStream("D:\\Code Java\\Java\\JavaCore\\Java_Serialization\\ObjectOutputStream\\TestObjectOutputStream.txt"));
            // create student
